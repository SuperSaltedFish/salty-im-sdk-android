...
public class ContactDao extends AbstractDao<ContactProfile> {
    ...
    public ContactDao(SQLiteServiceManager.ReadWriteHelper helper) {
        super(helper);
        mUserDao = new UserDao(helper);
    }

    @Override
    protected boolean insertToDatabase(ContactProfile entity, SQLiteServiceManager.WritableDatabase database, ContentValues values) {
    ...
    @Override
    protected boolean replaceFromDatabase(ContactProfile entity, SQLiteServiceManager.WritableDatabase database, ContentValues values) {
        database.beginTransactionNonExclusive();
        try {
            UserProfile profile = entity.getUserProfile();
    ...
    @Override
    protected boolean updateFromDatabase(ContactProfile entity, SQLiteServiceManager.WritableDatabase database, ContentValues values) {
        database.beginTransactionNonExclusive();
        try {
            UserProfile profile = entity.getUserProfile();
