...
//        database.beginTransactionNonExclusive();
//        try {
//            if (database.update(getTableName(), values, getPrimaryKeySelection(), getPrimaryKeySelectionArgs(entity)) > 0 && UserDao.replaceUser(database, userInfo, values)) {
//                database.setTransactionSuccessful();
//                result = true;
//            }
//        } finally {
...
//
//    @Override
//    protected String[] getPrimaryKeySelectionArgs(ContactOperationEntity entity) {
